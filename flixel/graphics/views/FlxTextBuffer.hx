 ...
 */
class FlxTextBuffer extends FlxImage
{
	/**
	...
	public function setFormat(?Font:String, Size:Int = 8, Color:FlxColor = FlxColor.WHITE, ?Alignment:FlxTextAlign, 
		?BorderStyle:FlxTextBorderStyle, BorderColor:FlxColor = FlxColor.TRANSPARENT, Embedded:Bool = true):FlxTextBuffer
	{
	...
	@:allow(flixel.text) private function regenGraphics():Void
	{
